...
import { ScrollView, Text, StyleSheet, ActivityIndicator, Alert, View, Dimensions,screenWidth } from 'react-native';
...
const StatScreen = () => {
  ...
  useEffect(() => {
    fetch('http://192.168.4.24:8000/stats/')  // hoặc IP LAN nếu dùng thiết bị thật
      .then((response) => {
